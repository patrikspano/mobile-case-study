...
@NonNullApi
public class MobileCaseStudyProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MobileCaseStudyProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
